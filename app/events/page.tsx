...
export default function Events() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-8 md:mb-12 text-gray-800 dark:text-gray-100">Our Events</h1>
      ...
      <div className="w-full mb-12 bg-black rounded-lg overflow-hidden shadow-lg">
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-2/5 h-64 lg:h-auto relative">
            ...
            />
            <div className="absolute top-0 left-0 bg-blue-900 text-white px-4 py-2 rounded-br-lg font-bold">
              UPCOMING EVENT
            </div>
          </div>
          
          <div className="lg:w-3/5 p-6 lg:p-10 text-white">
            <div className="mb-2 font-medium">{upcomingEvent.date}</div>
            <h2 className="text-2xl lg:text-3xl font-bold mb-4">{upcomingEvent.name}</h2>
            <p className="mb-6 text-white/80">{upcomingEvent.description}</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="bg-transparent border border-white text-white hover:bg-white/10 px-6 py-2 rounded-md font-medium transition-colors duration-200">
                Learn More
              </button>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-0 border-0 lg:border lg:border-gray-200 dark:border-white">
        {events.map((event) => (
          <div key={event.id} className="flex flex-col border border-gray-200 dark:border-white shadow-sm hover:shadow-md transition-shadow duration-300 p-4 md:p-6 h-full bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
            <div className="text-center mb-3 md:mb-4 text-black dark:text-white font-medium">{event.date}</div>
            ...
            <p className="text-gray-600 dark:text-white text-sm md:text-base flex-grow">
              {event.description}
            </p>
