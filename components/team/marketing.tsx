      ...
      <div className="flex flex-col md:flex-row justify-between md:mt-32 px-4 md:px-0">
        ...
        <div className="flex flex-col items-center mx-auto md:mx-16 mb-10 md:mb-0 md:order-2">
          ...
          <div className="text-center mt-4">
            ...
            <h2 className="text-2xl font-thin">Marketing Lead</h2>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center md:order-1">
          ...
          <div className="hidden md:block text-left pl-8 mb-24">
            <h1 className="text-8xl font-thin">Marketing Team</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mx-2 md:mx-10">
            ...
            <div className="flex flex-col items-center">
              <Image
                src="/teampic/pratyush.webp"
                alt="Team member"
                width={200}
                height={150}
                className="object-cover w-32 md:w-auto"
              />
              <h3 className="text-base md:text-xl font-thin mt-2 text-center">Pratyush Bhatt</h3>
            </div>

            {/* Team member 2 */}
            <div className="flex flex-col items-center">
              <Image
                src="/teampic/jiya.webp"
                alt="Team member"
                width={200}
                height={150}
                className="object-cover w-32 md:w-auto"
            ...
            <div className="flex flex-col items-center">
              <Image
                src="/teampic/rahul.webp"
                alt="Team member"
                width={200}
                height={150}
                className="object-cover w-32 md:w-auto"
              />
              <h3 className="text-base md:text-xl font-thin mt-2 text-center">Rahul Dixit</h3>
            </div>
          </div>
        </div>
      </div>
