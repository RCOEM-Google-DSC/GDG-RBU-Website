...
export default function Design() {
  ...
  <div className="flex flex-row justify-between mt-32">
    ...
    <div className="flex flex-col items-center rounded-none mx-16">
      ...
      />
      <h1 className="text-3xl font-bold text-black mt-4">Khushi Sonkusare</h1>
      <h1 className="text-2xl text-black">Design Lead</h1>
    </div>

    {/* Right side with team members in horizontal layout */}
    <div className="flex flex-col justify-center ">
    <div className="text-right pr-8 mb-24 ">
    <h1 className="text-8xl text-black ">Design Team</h1>
    <p className="text-3xl text-gray-700">
      ...
      <div className="grid grid-cols-3 gap-8 mx-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-xl font-medium mt-2">Mayuri Barapatre</h3>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-xl font-medium mt-2">Jiya Vij</h3>
        </div>
